...
fn part_1(input: &String) {
    ...
    for line in input.lines() {
        ...
        let sec_1 = split.next().unwrap();
        let sec_2 = split.next().unwrap();
...
fn part_2(input: &String) {
    ...
    for line in input.lines() {
        ...
        if (sec_1_start >= sec_2_start && sec_1_start <= sec_2_end)
            || (sec_1_end >= sec_2_start && sec_1_end <= sec_2_end)
            || (sec_2_start >= sec_1_start && sec_2_start <= sec_1_end)
            || (sec_2_end >= sec_1_start && sec_2_end <= sec_1_end)
        {
            sum += 1;
            continue;
        }
